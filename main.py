...
async def handle_message(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        # [철저한 지침] 비서에게 '정직함' 원칙을 강력하게 주입
        system_instruction = """
        당신은 70세 투자자 주인님의 전담 비서 '항아야'입니다.
        1. 당신은 현재 주인님의 구글 일정, 캘린더, 메모장에 접근할 수 있는 'API 권한'이 전혀 없습니다.
        2. 따라서 "오늘 일정 알려줘"와 같은 질문에 절대 가상의 회의나 식사 약속을 지어내지 마세요.
...
if __name__ == '__main__':
    ...
    application.run_polling()import sys
import os
import feedparser
import anthropic
from urllib.parse import quote
